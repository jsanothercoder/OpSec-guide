...
Тут есть выход, но нужно придерживаться правил:
...
- v2rayNG - универсальный клиент для многих протоколов. INCY создан для более удобного управления интерфейсом на базе технологии v2ray, ведь сам по себе v2rayNG не самый новый в плане дизайна.
...
В данном списке не будет бесплатных VPN, у каждого такого сервиса почти нет гарантии полной безопасности, могу лишь упомянуть Proton VPN, так как он является частью экосистемы Proton, он контролируется Швейцарским судом, поэтому может хранить логи активности для использования их в суде в случае проблем.
...
Тут выбор не очень большой. Для основной операционной системы, Windows подойдет, но что бы вырезать телеметрию, можно скачать какую-нибудь сборку Windows 10, но скачивать такие сборки на свой страх и риск, ведь с ними, анонимность может упасть, либо потратить 1-2 недели на детальный разбор регистра и его изменение.

Если нужна максимальная анонимность и удобство, обязательно ставить Linux.

>Вредные дистрибутивы
>Есть дистрибутивы, которые ничем особо от Windows в плане анонимности не отличаются, в основном это дистрибутивы для новичков: Ubuntu и Majaro. Они собирают телеметрию, что идет против философии Linux и ставят под сомнения анонимность.
...
#### Как лучше создать новый аккаунт?
Лучше использовать проверенные физические SIM карты, множество виртуальных SIM карт не дают возможность восстановить аккаунт в случае потери доступа к сессиям.

Можно взять e-SIM без паспорта. Одними из самых анонимных считаются e-SIM от T-Mobile.

Никогда не стоит брать просто активаторы, которые дают номер на 10~ минут для регистрации. Взять другую физическую SIM карту будет даже дешевле чем виртуальные.
